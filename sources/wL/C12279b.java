...
public final class C12279b {
    public static final void b(d dVar, C4889m mVar, int i10, int i11) {
        ...
        if ((i12 & 3) != 2 || !k10.l()) {
            ...
            if (C4895p.J()) {
                C4895p.S(1253169803, i12, -1, "com.ingka.ikea.app.uicomposables.loading.ProgressIndicator (ProgressIndicator.kt:20)");
            }
            C4747p0.c(J.h(dVar, 0.0f, 1, (Object) null), 0, 0, 0, 0.0f, k10, 0, 30);
            if (C4895p.J()) {
                C4895p.R();
            }
        } else {
        ...
        Y0 n10 = k10.n();
        if (n10 != null) {
            n10.a(new C12278a(dVar, i10, i11));
        }
    }
