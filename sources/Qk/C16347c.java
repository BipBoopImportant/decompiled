...
public final class C16347c extends C16354j {
    ...
    public static final class a {
        ...
        public final C16347c a() {
            if (b()) {
                return new C16347c((DefaultConstructorMarker) null);
            }
            return null;
        }

        public final boolean b() {
            return C16347c.f137699f;
        }
    ...
    public /* synthetic */ C16347c(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
    ...
    public SSLContext n() {
        SSLContext instance = SSLContext.getInstance("TLS", this.f137700d);
    ...
    private C16347c() {
        this.f137700d = new BouncyCastleJsseProvider();
    }
}
