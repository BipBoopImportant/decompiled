...
public final class j {
    ...
    private static final ThreadLocal<PathMeasure> f36972a = new a();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<Path> f36973b = new b();

    /* renamed from: c  reason: collision with root package name */
    private static final ThreadLocal<Path> f36974c = new c();

    /* renamed from: d  reason: collision with root package name */
    private static final ThreadLocal<float[]> f36975d = new d();

    /* renamed from: e  reason: collision with root package name */
    private static final float f36976e = ((float) (Math.sqrt(2.0d) / 2.0d));
    ...
    public static void a(Path path, float f10, float f11, float f12) {
        C8923e.b("applyTrimPathIfNeeded");
        PathMeasure pathMeasure = f36972a.get();
        Path path2 = f36973b.get();
        Path path3 = f36974c.get();
        pathMeasure.setPath(path, false);
        float length = pathMeasure.getLength();
        if (f10 == 1.0f && f11 == 0.0f) {
            C8923e.c("applyTrimPathIfNeeded");
    ...
    public static void b(Path path, u uVar) {
        if (uVar != null && !uVar.k()) {
            a(path, ((C9022d) uVar.i()).p() / 100.0f, ((C9022d) uVar.f()).p() / 100.0f, ((C9022d) uVar.h()).p() / 360.0f);
        }
    }
    ...
    public static void n(Canvas canvas, RectF rectF, Paint paint, int i10) {
        C8923e.b("Utils#saveLayer");
        canvas.saveLayer(rectF, paint);
        C8923e.c("Utils#saveLayer");
    }
}
