...
public final class Y {
    ...
    private static Map<VelocityTracker, Z> f8613a = Collections.synchronizedMap(new WeakHashMap());
    ...
    public static void a(VelocityTracker velocityTracker, MotionEvent motionEvent) {
        ...
        if (Build.VERSION.SDK_INT < 34 && motionEvent.getSource() == 4194304) {
            if (!f8613a.containsKey(velocityTracker)) {
                f8613a.put(velocityTracker, new Z());
            }
            f8613a.get(velocityTracker).a(motionEvent);
        }
    }
    ...
    private static Z e(VelocityTracker velocityTracker) {
        return f8613a.get(velocityTracker);
    }
}
