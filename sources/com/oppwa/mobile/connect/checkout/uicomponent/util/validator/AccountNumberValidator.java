...
public class AccountNumberValidator extends InputValidator {
    ...
    private final Pattern f121547d = Pattern.compile("[a-zA-Z0-9]{3,64}");
    ...
    public String checkForValidationError(String str) {
        if (str == null || str.isEmpty() || !this.f121547d.matcher(str).matches()) {
            return this.f121554a.getString(R.string.checkout_error_account_number_invalid);
        }
        return null;
    }
}
