...
public class Pose {
    public static final Pose IDENTITY = new Pose(new float[]{0.0f, 0.0f, 0.0f}, Quaternion.f67701a);
    @UsedByNative("session_jni_wrapper.cc")
    ...
    public Pose inverse() {
        float[] fArr = new float[3];
        Quaternion g10 = this.quaternion.g();
        Quaternion.j(g10, this.translation, 0, fArr, 0);
        fArr[0] = -fArr[0];
        fArr[1] = -fArr[1];
        fArr[2] = -fArr[2];
        return new Pose(fArr, g10);
    }
