...
public final class L<K, V> extends LinkedHashMap<K, V> {
    ...
    private static final L<?, ?> f69232b;

    /* renamed from: a  reason: collision with root package name */
    private boolean f69233a = true;
    ...
    static <K, V> boolean l(java.util.Map<K, V> r4, java.util.Map<K, V> r5) {
        ...
        L_0x0042:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.L.l(java.util.Map, java.util.Map):boolean");
    }
