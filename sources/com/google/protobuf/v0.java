...
interface v0 {
    ...
    void I(int i10, List<C9575h> list);

    void J(int i10, List<?> list, h0 h0Var);

    @Deprecated
    void K(int i10, Object obj, h0 h0Var);

    void L(int i10, C9575h hVar);

    @Deprecated
    void M(int i10, List<?> list, h0 h0Var);

    void N(int i10, Object obj, h0 h0Var);

    <K, V> void O(int i10, K.a<K, V> aVar, Map<K, V> map);
