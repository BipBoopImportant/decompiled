...
public class u {
    ...
    private static final Map<String, u> f68840c = new HashMap();

    /* renamed from: a  reason: collision with root package name */
    private final Context f68841a;

    /* renamed from: b  reason: collision with root package name */
    private final String f68842b;
    ...
    public synchronized Void a() {
        this.f68841a.deleteFile(this.f68842b);
        return null;
    }
    ...
    public synchronized com.google.firebase.remoteconfig.internal.g d() {
        /*
            ...
            monitor-enter(r6)
            r0 = 0
            android.content.Context r1 = r6.f68841a     // Catch:{ FileNotFoundException | JSONException -> 0x0032, all -> 0x002d }
            java.lang.String r2 = r6.f68842b     // Catch:{ FileNotFoundException | JSONException -> 0x0032, all -> 0x002d }
    ...
    public synchronized Void e(g gVar) {
        FileOutputStream openFileOutput = this.f68841a.openFileOutput(this.f68842b, 0);
        try {
