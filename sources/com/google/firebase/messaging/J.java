...
public class J {
    ...
    public J(Bundle bundle) {
        if (bundle != null) {
            this.f68343a = new Bundle(bundle);
            return;
        }
    ...
    private String w(String str) {
        if (!this.f68343a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v10 = v(str);
            if (this.f68343a.containsKey(v10)) {
                return v10;
            }
        }
        return str;
    ...
    public String i(Resources resources, String str, String str2) {
        ...
        int identifier = resources.getIdentifier(h10, FeatureVariable.STRING_TYPE, str);
        if (identifier == 0) {
    ...
    public String p(String str) {
        return this.f68343a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f68343a);
        for (String next : this.f68343a.keySet()) {
            if (!s(next)) {
                bundle.remove(next);
            }
        }
