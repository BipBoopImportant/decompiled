...
public final class JsonObject extends JsonElement {
    private final g<String, JsonElement> members = new g<>(false);
    ...
    public void addProperty(String str, String str2) {
        add(str, str2 == null ? k.f69184a : new JsonPrimitive(str2));
    }
    ...
    public void addProperty(String str, Number number) {
        add(str, number == null ? k.f69184a : new JsonPrimitive(number));
    }
    ...
    public void addProperty(String str, Boolean bool) {
        add(str, bool == null ? k.f69184a : new JsonPrimitive(bool));
    }

    public void addProperty(String str, Character ch2) {
        add(str, ch2 == null ? k.f69184a : new JsonPrimitive(ch2));
    }
}
