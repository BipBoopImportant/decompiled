...
public final class JsonArray extends JsonElement implements Iterable<JsonElement> {
    ...
    public void add(Boolean bool) {
        this.elements.add(bool == null ? k.f69184a : new JsonPrimitive(bool));
    }
    ...
    public void add(Character ch2) {
        this.elements.add(ch2 == null ? k.f69184a : new JsonPrimitive(ch2));
    }
    ...
    public void add(Number number) {
        this.elements.add(number == null ? k.f69184a : new JsonPrimitive(number));
    }

    public void add(String str) {
        this.elements.add(str == null ? k.f69184a : new JsonPrimitive(str));
    }
