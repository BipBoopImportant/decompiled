...
final class t0 {
    ...
    private static final b f68117a = ((!e.e() || C9521d.c()) ? new c() : new e());
    ...
    static final class c extends b {
        ...
        public int d(int r7, byte[] r8, int r9, int r10) {
            ...
            L_0x001c:
                ...
                int r7 = com.google.crypto.tink.shaded.protobuf.t0.j(r0, r9)
                return r7
            L_0x0031:
                r5 = r9
                r9 = r7
            ...
            L_0x0049:
                ...
                int r7 = com.google.crypto.tink.shaded.protobuf.t0.j(r0, r1)
                return r7
            L_0x005a:
                r9 = 0
                goto L_0x0062
            ...
            L_0x0062:
                ...
                int r7 = com.google.crypto.tink.shaded.protobuf.t0.k(r0, r1, r7)
                return r7
            L_0x006f:
                r5 = r9
                r9 = r7
            ...
            L_0x0086:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.t0.c.d(int, byte[], int, int):int");
        }
    }
    ...
    static final class e extends b {
        ...
        private static int f(byte[] r10, long r11, int r13) {
            ...
            L_0x0009:
                ...
                long r4 = r11 + r2
                byte r1 = com.google.crypto.tink.shaded.protobuf.s0.u(r10, r11)
            ...
            L_0x0029:
                ...
                long r2 = r2 + r11
                byte r11 = com.google.crypto.tink.shaded.protobuf.s0.u(r10, r11)
            ...
            L_0x0048:
                int r13 = r13 + -3
                long r2 = r2 + r11
                byte r0 = com.google.crypto.tink.shaded.protobuf.s0.u(r10, r11)
            ...
            L_0x005d:
                long r11 = r11 + r8
                byte r0 = com.google.crypto.tink.shaded.protobuf.s0.u(r10, r2)
            ...
            L_0x006d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = com.google.crypto.tink.shaded.protobuf.s0.u(r10, r8)
                if (r0 <= r6) goto L_0x0007
            L_0x008f:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.t0.e.f(byte[], long, int):int");
        }
        ...
        private static int g(byte[] bArr, long j10, int i10) {
            ...
            while (true) {
                int i13 = i11 + 8;
                if (i13 <= i10 && (s0.A(bArr, s0.f68100h + j10) & -9187201950435737472L) == 0) {
                    j10 += 8;
                    i11 = i13;
                }
            }
        ...
        private static int h(byte[] bArr, int i10, long j10, int i11) {
            ...
            if (i11 == 1) {
                return t0.j(i10, s0.u(bArr, j10));
            }
            if (i11 == 2) {
                return t0.k(i10, s0.u(bArr, j10), s0.u(bArr, j10 + 1));
            }
        ...
        public int b(java.lang.CharSequence r25, byte[] r26, int r27, int r28) {
            ...
            L_0x001a:
                ...
                long r11 = r11 + r4
                byte r3 = (byte) r13
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r4, r3)
                int r2 = r2 + 1
                r4 = r11
                goto L_0x001a
            L_0x002f:
            ...
            L_0x0033:
                ...
                long r14 = r4 + r11
                byte r13 = (byte) r13
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r4, r13)
                r22 = r6
                r17 = r10
                r20 = r11
                r4 = r14
            ...
            L_0x004f:
                ...
                byte r11 = (byte) r11
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r4, r11)
                long r4 = r4 + r15
                r11 = r13 & 63
                r11 = r11 | r3
                byte r11 = (byte) r11
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r9, r11)
            L_0x0070:
                r22 = r6
                r20 = 1
                goto L_0x00f8
            ...
            L_0x0085:
                ...
                r15 = r15 | r3
                byte r15 = (byte) r15
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r9, r15)
                r9 = 3
                long r4 = r4 + r9
                r9 = r13 & 63
                r9 = r9 | r3
                byte r9 = (byte) r9
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r11, r9)
                goto L_0x0070
            L_0x00ad:
                r11 = 4
                long r20 = r6 - r11
                ...
                byte r10 = (byte) r10
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r4, r10)
                r22 = r6
                long r6 = r4 + r15
                int r10 = r2 >>> 12
                r10 = r10 & 63
                r10 = r10 | r3
                byte r10 = (byte) r10
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r11, r10)
                r10 = 3
                long r11 = r4 + r10
                int r10 = r2 >>> 6
                r10 = r10 & 63
                r10 = r10 | r3
                byte r10 = (byte) r10
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r6, r10)
                r6 = 4
                long r4 = r4 + r6
                r2 = r2 & 63
                r2 = r2 | r3
                byte r2 = (byte) r2
                com.google.crypto.tink.shaded.protobuf.s0.K(r1, r11, r2)
                r2 = r9
            L_0x00f8:
                int r2 = r2 + 1
                r9 = r14
            ...
            L_0x0103:
                r2 = r9
            L_0x0104:
                com.google.crypto.tink.shaded.protobuf.t0$d r0 = new com.google.crypto.tink.shaded.protobuf.t0$d
                int r2 = r2 + -1
                r0.<init>(r2, r8)
                throw r0
            L_0x010c:
            ...
            L_0x0144:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.t0.e.b(java.lang.CharSequence, byte[], int, int):int");
        }

        /* access modifiers changed from: package-private */
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0058, code lost:
            if (com.google.crypto.tink.shaded.protobuf.s0.u(r12, r0) > -65) goto L_0x005d;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x009e, code lost:
            if (com.google.crypto.tink.shaded.protobuf.s0.u(r12, r0) > -65) goto L_0x00a0;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int d(int r11, byte[] r12, int r13, int r14) {
            ...
            L_0x0010:
                ...
                long r6 = r6 + r0
                byte r11 = com.google.crypto.tink.shaded.protobuf.s0.u(r12, r0)
            ...
            L_0x002a:
                ...
                int r11 = com.google.crypto.tink.shaded.protobuf.t0.j(r2, r11)
                return r11
            L_0x0043:
                r0 = r8
            L_0x0044:
            ...
            L_0x005e:
                ...
                long r8 = r0 + r6
                byte r3 = com.google.crypto.tink.shaded.protobuf.s0.u(r12, r0)
                int r11 = (r8 > r13 ? 1 : (r8 == r13 ? 0 : -1))
                if (r11 < 0) goto L_0x0073
                int r11 = com.google.crypto.tink.shaded.protobuf.t0.j(r2, r3)
                return r11
            L_0x0073:
                r11 = 0
                r0 = r8
            ...
            L_0x0079:
                ...
                int r11 = com.google.crypto.tink.shaded.protobuf.t0.k(r2, r3, r11)
                return r11
            L_0x008a:
                r0 = r8
            L_0x008b:
            ...
            L_0x00a8:
                ...
                throw r11
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.t0.e.d(int, byte[], int, int):int");
        }
    }

    static String e(byte[] bArr, int i10, int i11) {
        return f68117a.a(bArr, i10, i11);
    }

    static int f(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        return f68117a.b(charSequence, bArr, i10, i11);
    }
    ...
    static boolean m(byte[] bArr) {
        return f68117a.c(bArr, 0, bArr.length);
    }

    static boolean n(byte[] bArr, int i10, int i11) {
        return f68117a.c(bArr, i10, i11);
    }
}
