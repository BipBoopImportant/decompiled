...
final class s0 {
    ...
    private static final Unsafe f68093a = D();

    /* renamed from: b  reason: collision with root package name */
    private static final Class<?> f68094b = C9521d.b();

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f68095c = o(Long.TYPE);

    /* renamed from: d  reason: collision with root package name */
    private static final boolean f68096d = o(Integer.TYPE);

    /* renamed from: e  reason: collision with root package name */
    private static final e f68097e = B();

    /* renamed from: f  reason: collision with root package name */
    private static final boolean f68098f = T();

    /* renamed from: g  reason: collision with root package name */
    private static final boolean f68099g = S();

    /* renamed from: h  reason: collision with root package name */
    static final long f68100h;

    /* renamed from: i  reason: collision with root package name */
    private static final long f68101i;

    /* renamed from: j  reason: collision with root package name */
    private static final long f68102j;

    /* renamed from: k  reason: collision with root package name */
    private static final long f68103k;

    /* renamed from: l  reason: collision with root package name */
    private static final long f68104l;

    /* renamed from: m  reason: collision with root package name */
    private static final long f68105m;

    /* renamed from: n  reason: collision with root package name */
    private static final long f68106n;

    /* renamed from: o  reason: collision with root package name */
    private static final long f68107o;

    /* renamed from: p  reason: collision with root package name */
    private static final long f68108p;

    /* renamed from: q  reason: collision with root package name */
    private static final long f68109q;

    /* renamed from: r  reason: collision with root package name */
    private static final long f68110r;

    /* renamed from: s  reason: collision with root package name */
    private static final long f68111s;

    /* renamed from: t  reason: collision with root package name */
    private static final long f68112t;

    /* renamed from: u  reason: collision with root package name */
    private static final long f68113u = q(n());

    /* renamed from: v  reason: collision with root package name */
    private static final int f68114v;

    /* renamed from: w  reason: collision with root package name */
    static final boolean f68115w = (ByteOrder.nativeOrder() == ByteOrder.BIG_ENDIAN);
    ...
    private static final class b extends e {
        ...
        public boolean c(Object obj, long j10) {
            return s0.f68115w ? s0.s(obj, j10) : s0.t(obj, j10);
        }

        public byte d(Object obj, long j10) {
            return s0.f68115w ? s0.v(obj, j10) : s0.w(obj, j10);
        }
    ...
    private static final class d extends e {
        ...
        public boolean c(Object obj, long j10) {
            return this.f68116a.getBoolean(obj, j10);
        }

        public byte d(Object obj, long j10) {
            return this.f68116a.getByte(obj, j10);
        }

        public double e(Object obj, long j10) {
            return this.f68116a.getDouble(obj, j10);
        }

        public float f(Object obj, long j10) {
            return this.f68116a.getFloat(obj, j10);
        }

        public void k(Object obj, long j10, boolean z10) {
            this.f68116a.putBoolean(obj, j10, z10);
        }

        public void l(Object obj, long j10, byte b10) {
            this.f68116a.putByte(obj, j10, b10);
        }

        public void m(Object obj, long j10, double d10) {
            this.f68116a.putDouble(obj, j10, d10);
        }

        public void n(Object obj, long j10, float f10) {
            this.f68116a.putFloat(obj, j10, f10);
        }
        ...
        public boolean r() {
            ...
            try {
                Class<?> cls2 = this.f68116a.getClass();
    ...
    private static abstract class e {
        ...
        public final int a(Class<?> cls) {
            return this.f68116a.arrayBaseOffset(cls);
        }

        public final int b(Class<?> cls) {
            return this.f68116a.arrayIndexScale(cls);
        }
        ...
        public final int g(Object obj, long j10) {
            return this.f68116a.getInt(obj, j10);
        }

        public final long h(Object obj, long j10) {
            return this.f68116a.getLong(obj, j10);
        }

        public final Object i(Object obj, long j10) {
            return this.f68116a.getObject(obj, j10);
        }

        public final long j(Field field) {
            return this.f68116a.objectFieldOffset(field);
        }
        ...
        public final void o(Object obj, long j10, int i10) {
            this.f68116a.putInt(obj, j10, i10);
        }

        public final void p(Object obj, long j10, long j11) {
            this.f68116a.putLong(obj, j10, j11);
        }

        public final void q(Object obj, long j10, Object obj2) {
            this.f68116a.putObject(obj, j10, obj2);
        }

        public boolean r() {
            Class<Class> cls = Class.class;
            Class<Object> cls2 = Object.class;
            Unsafe unsafe = this.f68116a;
            if (unsafe == null) {
                return false;
            }
            try {
    ...
    static long A(Object obj, long j10) {
        return f68097e.h(obj, j10);
    }

    private static e B() {
        Unsafe unsafe = f68093a;
        if (unsafe == null) {
            return null;
        }
        if (!C9521d.c()) {
    ...
    static void K(byte[] bArr, long j10, byte b10) {
        f68097e.l(bArr, f68100h + j10, b10);
    }
    ...
    static <T> T k(Class<T> cls) {
        try {
            return f68093a.allocateInstance(cls);
    ...
    public static Field n() {
        ...
        if (C9521d.c() && (p10 = p(cls, "effectiveDirectAddress")) != null) {
            return p10;
        }
    ...
    private static long q(Field field) {
        e eVar;
        if (field == null || (eVar = f68097e) == null) {
            return -1;
        }
        return eVar.j(field);
    }
    ...
    static byte u(byte[] bArr, long j10) {
        return f68097e.d(bArr, f68100h + j10);
    }
    ...
    static double x(Object obj, long j10) {
        return f68097e.e(obj, j10);
    }

    static float y(Object obj, long j10) {
        return f68097e.f(obj, j10);
    }

    static int z(Object obj, long j10) {
        return f68097e.g(obj, j10);
    }
}
