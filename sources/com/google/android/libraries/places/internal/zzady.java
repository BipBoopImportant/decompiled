...
public final class zzady {
    ...
    public static int zza(int r5, int r6, java.math.RoundingMode r7) {
        ...
        L_0x000e:
            r5 = r5 ^ r6
            int[] r2 = com.google.android.libraries.places.internal.zzadx.zza
            int r3 = r7.ordinal()
            r2 = r2[r3]
            int r5 = r5 >> 31
            r3 = 1
        ...
        L_0x0049:
            ...
            return r0
        L_0x004b:
            com.google.android.libraries.places.internal.zzadz.zza(r4)
        L_0x004e:
            return r0
        L_0x004f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.places.internal.zzady.zza(int, int, java.math.RoundingMode):int");
    }

    public static int zzb(int i10, RoundingMode roundingMode) {
        if (i10 > 0) {
            switch (zzadx.zza[roundingMode.ordinal()]) {
                case 1:
                    zzadz.zza(((i10 + -1) & i10) == 0);
                    break;
                case 2:
                case 3:
                    break;
