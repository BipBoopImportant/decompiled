...
final class C7341k6 extends C7314h6 {
    C7341k6() {
    }
    ...
    /* access modifiers changed from: package-private */
    public final int b(String str, byte[] bArr, int i10, int i11) {
        int i12;
        int i13;
        char charAt;
        ...
        while (i15 < length) {
            ...
            if (charAt2 < 128 && i16 < i14) {
                ...
                throw new C7332j6(i15 - 1, length);
        ...
        if ((i10 | i11 | ((bArr.length - i10) - i11)) >= 0) {
            ...
            while (r11 < i12) {
                ...
                if (b11 >= 0) {
                    ...
                    if (i15 < i12) {
                        r11 += 2;
                        C7323i6.c(b11, bArr[i15], cArr, i14);
                        i14++;
                    } else {
                        throw U4.c();
                    }
                    ...
                    if (i15 < i12 - 1) {
                        int i17 = r11 + 2;
                        r11 += 3;
                        C7323i6.b(b11, bArr[i15], bArr[i17], cArr, i14);
                        i14++;
                    } else {
                        throw U4.c();
                    }
                    ...
                    byte b14 = bArr[r11 + 2];
                    r11 += 4;
                    C7323i6.a(b11, b13, b14, bArr[i18], cArr, i14);
                    i14 += 2;
                } else {
                    throw U4.c();
                }
