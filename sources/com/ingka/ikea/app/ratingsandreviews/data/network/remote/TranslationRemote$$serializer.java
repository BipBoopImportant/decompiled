...
@C16814e
public /* synthetic */ class TranslationRemote$$serializer implements N<TranslationRemote> {
    public static final TranslationRemote$$serializer INSTANCE;

    /* renamed from: a  reason: collision with root package name */
    public static final int f91109a = 8;
    private static final SerialDescriptor descriptor;

    static {
        TranslationRemote$$serializer translationRemote$$serializer = new TranslationRemote$$serializer();
        INSTANCE = translationRemote$$serializer;
        J0 j02 = new J0("com.ingka.ikea.app.ratingsandreviews.data.network.remote.TranslationRemote", translationRemote$$serializer, 4);
        j02.p("reviewId", false);
        j02.p("text", false);
        j02.p("title", false);
    ...
    private TranslationRemote$$serializer() {
    }

    /* renamed from: b */
    public final TranslationRemote deserialize(Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new TranslationRemote(i10, str4, str3, str2, str, (T0) null);
    }

    /* renamed from: c */
    public final void serialize(Encoder encoder, TranslationRemote translationRemote) {
        C17542s.j(encoder, "encoder");
        C17542s.j(translationRemote, "value");
        SerialDescriptor serialDescriptor = descriptor;
        C17395d b10 = encoder.b(serialDescriptor);
        TranslationRemote.b(translationRemote, b10, serialDescriptor);
        b10.c(serialDescriptor);
    }
