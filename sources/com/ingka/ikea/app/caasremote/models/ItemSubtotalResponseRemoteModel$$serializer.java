...
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u001a\u0010\u0007\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005HÖ\u0001¢\u0006\u0004\b\u0007\u0010\bJ\u0018\u0010\u000b\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\tHÖ\u0001¢\u0006\u0004\b\u000b\u0010\fJ \u0010\u0011\u001a\u00020\u00102\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000f\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\u0011\u0010\u0012R\u0014\u0010\u0016\u001a\u00020\u00138VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0017"}, d2 = {"com/ingka/ikea/app/caasremote/models/ItemSubtotalResponseRemoteModel.$serializer", "LjK/N;", "Lcom/ingka/ikea/app/caasremote/models/ItemSubtotalResponseRemoteModel;", "<init>", "()V", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "b", "(Lkotlinx/serialization/encoding/Decoder;)Lcom/ingka/ikea/app/caasremote/models/ItemSubtotalResponseRemoteModel;", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "LXH/N;", "c", "(Lkotlinx/serialization/encoding/Encoder;Lcom/ingka/ikea/app/caasremote/models/ItemSubtotalResponseRemoteModel;)V", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "caasremote"}, k = 1, mv = {1, 9, 0}, xi = 48)
@C16814e
public final class ItemSubtotalResponseRemoteModel$$serializer implements N<ItemSubtotalResponseRemoteModel> {
    public static final ItemSubtotalResponseRemoteModel$$serializer INSTANCE;
    private static final /* synthetic */ J0 descriptor;

    static {
        ItemSubtotalResponseRemoteModel$$serializer itemSubtotalResponseRemoteModel$$serializer = new ItemSubtotalResponseRemoteModel$$serializer();
        INSTANCE = itemSubtotalResponseRemoteModel$$serializer;
        J0 j02 = new J0("com.ingka.ikea.app.caasremote.models.ItemSubtotalResponseRemoteModel", itemSubtotalResponseRemoteModel$$serializer, 4);
        j02.p("base", false);
        j02.p("current", false);
        j02.p("savings", false);
        j02.p("upsell", false);
    ...
    private ItemSubtotalResponseRemoteModel$$serializer() {
    }

    /* renamed from: b */
    public ItemSubtotalResponseRemoteModel deserialize(Decoder decoder) {
        ...
        b10.c(descriptor2);
        return new ItemSubtotalResponseRemoteModel(i10, nullableBasePricePropertiesRemoteModel, currentPricePropertiesRemoteModel, nullableTotalSavingsRemoteModel, nullableUpsellPricePropertiesRemoteModel, (T0) null);
    }

    /* renamed from: c */
    public void serialize(Encoder encoder, ItemSubtotalResponseRemoteModel itemSubtotalResponseRemoteModel) {
        C17542s.j(encoder, "encoder");
        C17542s.j(itemSubtotalResponseRemoteModel, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        C17395d b10 = encoder.b(descriptor2);
        ItemSubtotalResponseRemoteModel.d(itemSubtotalResponseRemoteModel, b10, descriptor2);
        b10.c(descriptor2);
    }
