...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\b!\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u000f\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0005\u0010\u0003J-\u0010\r\u001a\u0004\u0018\u00010\f2\u0006\u0010\u0007\u001a\u00020\u00062\b\u0010\t\u001a\u0004\u0018\u00010\b2\b\u0010\u000b\u001a\u0004\u0018\u00010\nH\u0016¢\u0006\u0004\b\r\u0010\u000eJ!\u0010\u0010\u001a\u00020\u00042\u0006\u0010\u000f\u001a\u00020\f2\b\u0010\u000b\u001a\u0004\u0018\u00010\nH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u000f\u0010\u0012\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u0012\u0010\u0003J\u000f\u0010\u0014\u001a\u00020\u0013H%¢\u0006\u0004\b\u0014\u0010\u0015R\u0018\u0010\u0019\u001a\u0004\u0018\u00010\u00168\u0002@\u0002X\u000e¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u0014\u0010\u001d\u001a\u00020\u001a8\u0002X\u0004¢\u0006\u0006\n\u0004\b\u001b\u0010\u001cR\u0014\u0010 \u001a\u00020\u00168DX\u0004¢\u0006\u0006\u001a\u0004\b\u001e\u0010\u001f¨\u0006!"}, d2 = {"Lcom/ingka/ikea/energylabel/impl/SectionBaseFragment;", "Lcom/ingka/ikea/core/android/fragments/BaseFragment;", "<init>", "()V", "LXH/N;", "L0", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "Landroid/os/Bundle;", "savedInstanceState", "Landroid/view/View;", "onCreateView", "(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;", "view", "onViewCreated", "(Landroid/view/View;Landroid/os/Bundle;)V", "onDestroyView", "", "H0", "()I", "Llq/d;", "R", "Llq/d;", "_binding", "Ljava/lang/Runnable;", "S", "Ljava/lang/Runnable;", "runnable", "G0", "()Llq/d;", "binding", "energylabel-implementation_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public abstract class SectionBaseFragment extends c {

    /* renamed from: R  reason: collision with root package name */
    private d f95705R;

    /* renamed from: S  reason: collision with root package name */
    private final Runnable f95706S = new p(this);
    ...
    public static final void J0(SectionBaseFragment sectionBaseFragment, View view) {
        ...
        d dVar = sectionBaseFragment.f95705R;
        if (dVar != null && (recyclerView = dVar.f99476d) != null) {
            recyclerView.F1(0);
        }
    }
    ...
    public static final void K0(SectionBaseFragment sectionBaseFragment) {
        sectionBaseFragment.G0().f99474b.setVisibility(0);
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.f95705R = d.c(layoutInflater, viewGroup, false);
        return G0().getRoot();
    }

    public void onDestroyView() {
        super.onDestroyView();
        G0().getRoot().removeCallbacks(this.f95706S);
        this.f95705R = null;
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        C17542s.g(toolbar);
        t.f(this, toolbar, new q(this), new r(this));
        L0();
    }
}
