...
@Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\f\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0001\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0019\u0010\u0007\u001a\u00020\u00062\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u000f\u0010\n\u001a\u00020\tH\u0015¢\u0006\u0004\b\n\u0010\u000bR\u001a\u0010\u0010\u001a\u00020\u00068\u0014XD¢\u0006\f\n\u0004\b\f\u0010\r\u001a\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0013\u001a\u00020\u00068\u0014XD¢\u0006\f\n\u0004\b\u0011\u0010\r\u001a\u0004\b\u0012\u0010\u000fR\u001a\u0010\u0015\u001a\u00020\u00068\u0014XD¢\u0006\f\n\u0004\b\r\u0010\r\u001a\u0004\b\u0014\u0010\u000fR\"\u0010\u001d\u001a\u00020\u00168\u0006@\u0006X.¢\u0006\u0012\n\u0004\b\u0017\u0010\u0018\u001a\u0004\b\u0019\u0010\u001a\"\u0004\b\u001b\u0010\u001cR\u001b\u0010#\u001a\u00020\u001e8BX\u0002¢\u0006\f\n\u0004\b\u001f\u0010 \u001a\u0004\b!\u0010\"R\"\u0010)\u001a\u0010\u0012\f\u0012\n &*\u0004\u0018\u00010%0%0$8\u0002X\u0004¢\u0006\u0006\n\u0004\b'\u0010(¨\u0006,²\u0006\f\u0010+\u001a\u00020*8\nX\u0002"}, d2 = {"Lcom/ingka/ikea/account/impl/modalsettings/deleteaccount/DeleteAccountFragment;", "Lcom/ingka/ikea/core/android/fragments/BaseComposeFragment;", "<init>", "()V", "Lcom/ingka/ikea/account/impl/modalsettings/deleteaccount/a;", "navigateTo", "", "I0", "(Lcom/ingka/ikea/account/impl/modalsettings/deleteaccount/a;)Z", "LXH/N;", "D0", "(LU0/m;I)V", "X", "Z", "v0", "()Z", "drawUnderStatusBar", "Y", "u0", "drawUnderNavigationBar", "t0", "drawUnderDisplayCutout", "LEo/a;", "y0", "LEo/a;", "J0", "()LEo/a;", "setChromeCustomTabs", "(LEo/a;)V", "chromeCustomTabs", "Lcom/ingka/ikea/account/impl/modalsettings/deleteaccount/c;", "z0", "LXH/o;", "K0", "()Lcom/ingka/ikea/account/impl/modalsettings/deleteaccount/c;", "viewModel", "Lg/c;", "Lcom/ingka/ikea/account/impl/modalsettings/C;", "kotlin.jvm.PlatformType", "A0", "Lg/c;", "hostedRedirect", "Lce/b;", "uiState", "account-implementation_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class DeleteAccountFragment extends d {

    /* renamed from: A0  reason: collision with root package name */
    private final C5314c<C> f69686A0;

    /* renamed from: X  reason: collision with root package name */
    private final boolean f69687X;

    /* renamed from: Y  reason: collision with root package name */
    private final boolean f69688Y;

    /* renamed from: Z  reason: collision with root package name */
    private final boolean f69689Z;

    /* renamed from: y0  reason: collision with root package name */
    public Eo.a f69690y0;

    /* renamed from: z0  reason: collision with root package name */
    private final C16824o f69691z0;

    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    /* synthetic */ class a extends C17540p implements C17642l<b, C16807N> {
        a(Object obj) {
            super(1, obj, c.class, "onEvent", "onEvent(Lcom/ingka/ikea/account/impl/modalsettings/deleteaccount/DeleteAccount$Event;)V", 0);
        }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            L_0x002b:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ingka.ikea.account.impl.modalsettings.deleteaccount.DeleteAccountFragment.b.<clinit>():void");
        }
    }
    ...
    public static final class c extends C17544u implements C17631a<C5187o> {
        ...
        final /* synthetic */ C5187o f69693c;
    ...
    public static final class d extends C17544u implements C17631a<k0> {
        ...
        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ C17631a f69694c;
    ...
    public static final class e extends C17544u implements C17631a<j0> {
        ...
        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ C16824o f69695c;
        ...
        public final j0 invoke() {
            return W.d(this.f69695c).getViewModelStore();
        }
    }
    ...
    public static final class f extends C17544u implements C17631a<l3.a> {
        ...
        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ C17631a f69696c;

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ C16824o f69697d;
        ...
        public final l3.a invoke() {
            l3.a aVar;
            C17631a aVar2 = this.f69696c;
            if (aVar2 != null && (aVar = (l3.a) aVar2.invoke()) != null) {
                return aVar;
            }
            k0 a10 = W.d(this.f69697d);
    ...
    public static final class g extends C17544u implements C17631a<i0.c> {
        ...
        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ C5187o f69698c;

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ C16824o f69699d;
        ...
        public final i0.c invoke() {
            ...
            k0 a10 = W.d(this.f69699d);
            C5212o oVar = a10 instanceof C5212o ? (C5212o) a10 : null;
            return (oVar == null || (defaultViewModelProviderFactory = oVar.getDefaultViewModelProviderFactory()) == null) ? this.f69698c.getDefaultViewModelProviderFactory() : defaultViewModelProviderFactory;
        }
    }

    public DeleteAccountFragment() {
        C16824o a10 = C16825p.a(s.NONE, new d(new c(this)));
        this.f69691z0 = W.b(this, P.b(c.class), new e(a10), new f((C17631a) null, a10), new g(this, a10));
        C5314c<C> registerForActivityResult = registerForActivityResult(new HostedRedirectActivity.Companion.a(), new C9455c(this));
        C17542s.i(registerForActivityResult, "registerForActivityResult(...)");
        this.f69686A0 = registerForActivityResult;
    }

    private static final C9454b H0(A1<C9454b> a12) {
        return a12.getValue();
    }
    ...
    private final boolean I0(a aVar) {
        ...
        if (aVar instanceof a.C1203a) {
            rw.d.a(this, ((a.C1203a) aVar).a(), "DeleteAccount-Request-Key");
            androidx.navigation.fragment.a.a(this).k0();
            return true;
        } else if (aVar instanceof a.b) {
            J0().a(requireContext(), ((a.b) aVar).a());
            return true;
        } else if (aVar instanceof a.c) {
            this.f69686A0.a(new C(((a.c) aVar).a(), HostedRedirectActivity.Companion.RedirectUseCase.DELETE_ACCOUNT));
            return true;
        } else {
            throw new t();
        }
    ...
    private final c K0() {
        return (c) this.f69691z0.getValue();
    }

    /* access modifiers changed from: private */
    public static final void L0(DeleteAccountFragment deleteAccountFragment, HostedRedirectActivity.Companion.b bVar) {
            ...
            if (bVar instanceof HostedRedirectActivity.Companion.b.C1198b) {
                ...
                if (i10 == 1 || i10 == 2 || i10 == 3) {
                    ...
                    for (C11819b bVar2 : arrayList) {
                        ...
                        String str3 = str;
                        if (str2 == null) {
                            String name = deleteAccountFragment.getClass().getName();
                            C17542s.g(name);
                    ...
                    deleteAccountFragment.K0().I(b.a.f69703a);
                } else {
                    throw new t();
                }
            } else {
    ...
    public void D0(C4889m mVar, int i10) {
        mVar.W(767731689);
        if (C4895p.J()) {
            C4895p.S(767731689, i10, -1, "com.ingka.ikea.account.impl.modalsettings.deleteaccount.DeleteAccountFragment.FragmentContent (DeleteAccountFragment.kt:61)");
        }
        A1<C9454b> c10 = j3.a.c(K0().m(), (C5221y) null, (r.b) null, (C17168i) null, mVar, 0, 7);
        if (I0(H0(c10).d())) {
            K0().I(b.e.f69707a);
        }
        C9454b H02 = H0(c10);
        ...
        mVar.P();
        de.e.i(H02, (C17642l) ((C18059h) D10), mVar, 0);
        if (C4895p.J()) {
            C4895p.R();
        }
        mVar.P();
    ...
    public final Eo.a J0() {
        Eo.a aVar = this.f69690y0;
        if (aVar != null) {
            return aVar;
        }
        C17542s.z("chromeCustomTabs");
        return null;
    }
