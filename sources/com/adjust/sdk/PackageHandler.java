...
public class PackageHandler implements IPackageHandler, IActivityPackageSender.ResponseDataCallbackSubscriber {
    ...
    public class b implements Runnable {
        ...
        public final /* synthetic */ ActivityPackage f45908a;

        public b(ActivityPackage activityPackage) {
            this.f45908a = activityPackage;
        }

        public final void run() {
            PackageHandler.this.addI(this.f45908a);
        }
    }
    ...
    public class f implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ SessionParameters f45913a;

        public f(SessionParameters sessionParameters) {
            this.f45913a = sessionParameters;
        }

        public final void run() {
            PackageHandler.this.updatePackagesI(this.f45913a);
        }
    }
