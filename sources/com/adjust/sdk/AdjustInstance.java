...
public class AdjustInstance {
    ...
    public class a implements IRunActivityHandler {
        ...
        public final /* synthetic */ String f45872a;
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.addSessionCallbackParameterI(this.f45872a, this.f45873b);
        }
    }
    ...
    public class b implements IRunActivityHandler {
        ...
        /* renamed from: b  reason: collision with root package name */
        public final /* synthetic */ String f45875b;
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.addSessionPartnerParameterI(this.f45874a, this.f45875b);
        }
    }
    ...
    public class c implements IRunActivityHandler {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ String f45876a;
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.removeSessionCallbackParameterI(this.f45876a);
        }
    }
    ...
    public class d implements IRunActivityHandler {
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.removeSessionPartnerParameterI(this.f45877a);
        }
    }
