...
/* renamed from: ha.f6  reason: case insensitive filesystem */
public enum C8005f6 implements Q0 {
    UNKNOWN_EVENT(0),
    ...
    CUSTOM_MODEL_RUN(CheckoutActivity.RESULT_ERROR),
    ...
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(CheckoutActivity.RESULT_CANCELED),
