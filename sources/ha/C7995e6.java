...
/* renamed from: ha.e6  reason: case insensitive filesystem */
public enum C7995e6 implements Q0 {
    NO_ERROR(0),
    ...
    URI_EXPIRED(CheckoutActivity.RESULT_CANCELED),
    NO_NETWORK_CONNECTION(CheckoutActivity.RESULT_ERROR),
    METERED_NETWORK(103),
    DOWNLOAD_FAILED(104),
