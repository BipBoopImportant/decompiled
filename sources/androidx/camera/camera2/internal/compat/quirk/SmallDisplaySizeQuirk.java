...
public class SmallDisplaySizeQuirk implements N0 {
    ...
    private static final Map<String, Size> f16644a;
    ...
    static boolean g() {
        return f16644a.containsKey(Build.MODEL.toUpperCase(Locale.US));
    }

    public Size f() {
        return f16644a.get(Build.MODEL.toUpperCase(Locale.US));
    }
}
