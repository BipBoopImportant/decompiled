    ...
    private boolean C(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == C5426f.f23980F) {
                    view = childAt;
                } else if (id2 == C5426f.f23991k) {
                    view2 = childAt;
                } else if ((id2 != C5426f.f23993m && id2 != C5426f.f23995o) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            ...
            view2.measure(i16, View.MeasureSpec.makeMeasureSpec(i14, CatalogRepository.FETCH_FLAG_SDB));
