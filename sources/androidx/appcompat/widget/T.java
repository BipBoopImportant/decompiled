...
public class T extends E {
    ...
    private static boolean f16425c = false;

    /* renamed from: b  reason: collision with root package name */
    private final WeakReference<Context> f16426b;

    public T(Context context, Resources resources) {
        super(resources);
        this.f16426b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) {
        Context context = this.f16426b.get();
        if (context != null) {
            return D.g().s(context, this, i10);
        }
        return a(i10);
    }
