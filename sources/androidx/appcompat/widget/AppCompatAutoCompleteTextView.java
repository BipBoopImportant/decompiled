...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView {
    ...
    private static final int[] f16060d = {16843126};

    /* renamed from: a  reason: collision with root package name */
    private final C4990b f16061a;

    /* renamed from: b  reason: collision with root package name */
    private final C5003o f16062b;

    /* renamed from: c  reason: collision with root package name */
    private final C4994f f16063c;
    ...
    public void drawableStateChanged() {
        ...
        C4990b bVar = this.f16061a;
        if (bVar != null) {
            bVar.b();
        }
        C5003o oVar = this.f16062b;
        if (oVar != null) {
            oVar.b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f16062b.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f16062b.k();
    }

    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f16063c.e(C4996h.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f16063c.a(keyListener));
    }
    ...
    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeSet, int i10) {
        ...
        H.a(this, getContext());
        M v10 = M.v(getContext(), attributeSet, f16060d, i10, 0);
        if (v10.s(0)) {
