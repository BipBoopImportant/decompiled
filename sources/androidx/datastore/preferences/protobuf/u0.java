...
interface u0 {
    ...
    void I(int i10, List<C5154g> list);

    @Deprecated
    void J(int i10, List<?> list, h0 h0Var);

    void K(int i10, C5154g gVar);

    void L(int i10, Object obj, h0 h0Var);

    <K, V> void M(int i10, K.a<K, V> aVar, Map<K, V> map);

    @Deprecated
    void N(int i10, Object obj, h0 h0Var);

    void O(int i10, List<?> list, h0 h0Var);
