...
public final class p {
    ...
    static final class a extends l implements nI.p<Q, C17164e<? super C16807N>, Object> {
        ...
        final /* synthetic */ k f28606d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ C4899r0<Boolean> f28607e;
        ...
        static final class C0451a<T> implements C16533h {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ List<o.b> f28608a;

            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ C4899r0<Boolean> f28609b;

            C0451a(List<o.b> list, C4899r0<Boolean> r0Var) {
                this.f28608a = list;
                this.f28609b = r0Var;
            }
            ...
            public final Object emit(j jVar, C17164e<? super C16807N> eVar) {
                if (jVar instanceof o.b) {
                    this.f28608a.add(jVar);
                } else if (jVar instanceof o.c) {
                    this.f28608a.remove(((o.c) jVar).a());
                } else if (jVar instanceof o.a) {
                    this.f28608a.remove(((o.a) jVar).a());
                }
                this.f28609b.setValue(b.a(!this.f28608a.isEmpty()));
        ...
        public final C17164e<C16807N> create(Object obj, C17164e<?> eVar) {
            return new a(this.f28606d, this.f28607e, eVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                ...
                C16532g<j> c10 = this.f28606d.c();
                C0451a aVar = new C0451a(arrayList, this.f28607e);
                this.f28605c = 1;
    ...
    public static final A1<Boolean> a(k kVar, C4889m mVar, int i10) {
        if (C4895p.J()) {
            C4895p.S(-1692965168, i10, -1, "androidx.compose.foundation.interaction.collectIsPressedAsState (PressInteraction.kt:83)");
        }
        Object D10 = mVar.D();
