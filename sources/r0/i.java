...
public final class i {
    ...
    static final class a extends l implements p<Q, C17164e<? super C16807N>, Object> {
        ...
        final /* synthetic */ k f28597d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ C4899r0<Boolean> f28598e;
        ...
        static final class C0450a<T> implements C16533h {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ List<g> f28599a;

            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ C4899r0<Boolean> f28600b;

            C0450a(List<g> list, C4899r0<Boolean> r0Var) {
                this.f28599a = list;
                this.f28600b = r0Var;
            }
            ...
            public final Object emit(j jVar, C17164e<? super C16807N> eVar) {
                if (jVar instanceof g) {
                    this.f28599a.add(jVar);
                } else if (jVar instanceof h) {
                    this.f28599a.remove(((h) jVar).a());
                }
                this.f28600b.setValue(b.a(!this.f28599a.isEmpty()));
        ...
        public final C17164e<C16807N> create(Object obj, C17164e<?> eVar) {
            return new a(this.f28597d, this.f28598e, eVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                ...
                C16532g<j> c10 = this.f28597d.c();
                C0450a aVar = new C0450a(arrayList, this.f28598e);
                this.f28596c = 1;
    ...
    public static final A1<Boolean> a(k kVar, C4889m mVar, int i10) {
        if (C4895p.J()) {
            C4895p.S(1206586544, i10, -1, "androidx.compose.foundation.interaction.collectIsHoveredAsState (HoverInteraction.kt:64)");
        }
        Object D10 = mVar.D();
