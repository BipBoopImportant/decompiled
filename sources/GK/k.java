...
@Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u000f\u0010\u0001\u001a\u00020\u0000H\u0001¢\u0006\u0004\b\u0001\u0010\u0002¨\u0006\u0003"}, d2 = {"LT0/d;", "a", "(LU0/m;I)I", "splash_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class k {
    public static final int a(C4889m mVar, int i10) {
        mVar.W(1920766715);
        if (C4895p.J()) {
            C4895p.S(1920766715, i10, -1, "com.ingka.ikea.app.splash.onboarding.steps.features.compose.getWindowWidthSizeClass (WindowSizeClass.kt:21)");
        }
