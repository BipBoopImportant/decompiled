...
public final class h {
    public static final void b(int i10, C17642l<? super CachedCatalogItem, C16807N> lVar, C17631a<C16807N> aVar, C4889m mVar, int i11) {
        ...
        if ((i13 & 147) != 146 || !k10.l()) {
            if (C4895p.J()) {
                C4895p.S(403283704, i13, -1, "com.sugarcube.decorate.v2.internal.ui.catalog.ui.swap.SwapStripe (SwapStripe.kt:24)");
            }
            k10.C(1890788296);
            ...
            if (a10 != null) {
                ...
                k10.C(1729797275);
                f0 b10 = c.b(i.class, a10, (String) null, a11, a10 instanceof C5212o ? ((C5212o) a10).getDefaultViewModelCreationExtras() : a.C0407a.f25486b, k10, 36936, 0);
                k10.U();
                k10.U();
                m.g((i) b10, i10, lVar, aVar, k10, (i13 << 3) & 8176);
                if (C4895p.J()) {
                    C4895p.R();
                }
            } else {
