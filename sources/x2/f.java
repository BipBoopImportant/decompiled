...
public final class f {
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f31843a != bVarArr2[i10].f31843a || bVarArr[i10].f31844b.length != bVarArr2[i10].f31844b.length) {
                return false;
            }
        }
        return true;
    ...
    private static void g(java.lang.String r8, int r9, x2.f.a r10) {
        /*
            r0 = 0
            r10.f31842b = r0
            r1 = r9
        ...
        L_0x003c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: x2.f.g(java.lang.String, int, x2.f$a):void");
    }
    ...
    public static void j(b[] bVarArr, Path path) {
        ...
        char c10 = 'm';
        for (b bVar : bVarArr) {
            b.e(path, fArr, c10, bVar.f31843a, bVar.f31844b);
            c10 = bVar.f31843a;
        }
    }
    ...
    public static void k(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            char unused = bVarArr[i10].f31843a = bVarArr2[i10].f31843a;
            for (int i11 = 0; i11 < bVarArr2[i10].f31844b.length; i11++) {
                bVarArr[i10].f31844b[i11] = bVarArr2[i10].f31844b[i11];
            }
        }
    }
    ...
    public static class b {
        ...
        public static void e(android.graphics.Path r25, float[] r26, char r27, char r28, float[] r29) {
            ...
            L_0x02dc:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: x2.f.b.e(android.graphics.Path, float[], char, char, float[]):void");
        }
        ...
        private static void g(Path path, float f10, float f11, float f12, float f13, float f14, float f15, float f16, boolean z10, boolean z11) {
            ...
            if (d32 < 0.0d) {
                ...
                g(path, f10, f11, f12, f13, f19 * sqrt, f15 * sqrt, f16, z10, z11);
                return;
            }
            ...
            double d35 = d11 * d24;
            double d36 = d10 * d20;
            f(path, (d35 * cos) - (d36 * d30), (d35 * d30) + (d36 * cos), d24, d20, d14, d19, radians, atan2, atan22);
        }
        ...
        b(b bVar) {
            this.f31843a = bVar.f31843a;
            float[] fArr = bVar.f31844b;
            this.f31844b = f.c(fArr, 0, fArr.length);
        }
    }
}
