...
public final class a {
    ...
    private static final AtomicReference<byte[]> f40995a = new AtomicReference<>();
    ...
    public static java.nio.ByteBuffer a(java.io.File r8) {
        ...
        L_0x0050:
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: Y7.a.a(java.io.File):java.nio.ByteBuffer");
    }

    public static ByteBuffer b(InputStream inputStream) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(16384);
        byte[] andSet = f40995a.getAndSet((Object) null);
        if (andSet == null) {
    ...
    public static byte[] e(ByteBuffer byteBuffer) {
        b c10 = c(byteBuffer);
        if (c10 != null && c10.f40998a == 0 && c10.f40999b == c10.f41000c.length) {
    ...
    public static void f(java.nio.ByteBuffer r3, java.io.File r4) {
        ...
        L_0x0031:
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: Y7.a.f(java.nio.ByteBuffer, java.io.File):void");
    }

    public static InputStream g(ByteBuffer byteBuffer) {
        return new C0691a(byteBuffer);
    }

    /* renamed from: Y7.a$a  reason: collision with other inner class name */
    private static class C0691a extends InputStream {

        /* renamed from: a  reason: collision with root package name */
        private final ByteBuffer f40996a;

        /* renamed from: b  reason: collision with root package name */
        private int f40997b = -1;

        C0691a(ByteBuffer byteBuffer) {
            this.f40996a = byteBuffer;
        }

        public int available() {
            return this.f40996a.remaining();
        }

        public synchronized void mark(int i10) {
            this.f40997b = this.f40996a.position();
        }
        ...
        public int read() {
            if (!this.f40996a.hasRemaining()) {
                return -1;
            }
            return this.f40996a.get() & 255;
        }

        public synchronized void reset() {
            int i10 = this.f40997b;
            if (i10 != -1) {
                this.f40996a.position(i10);
            } else {
        ...
        public long skip(long j10) {
            ...
            ByteBuffer byteBuffer = this.f40996a;
