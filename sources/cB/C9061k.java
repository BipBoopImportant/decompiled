...
public final class C9061k extends C9541y<C9061k, b> implements T {
    /* access modifiers changed from: private */
    public static final C9061k DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    private static volatile a0<C9061k> PARSER;
    private int ivSize_;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58949a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58949a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58949a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58949a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58949a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58949a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.C9061k.a.<clinit>():void");
        }
    }

    /* renamed from: Cb.k$b */
    public static final class b extends C9541y.a<C9061k, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        private b() {
            super(C9061k.DEFAULT_INSTANCE);
        }
    }

    static {
        C9061k kVar = new C9061k();
        DEFAULT_INSTANCE = kVar;
        C9541y.N(C9061k.class, kVar);
    }

    private C9061k() {
    }

    public static C9061k S() {
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58949a[fVar.ordinal()]) {
            ...
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                a0<C9061k> a0Var = PARSER;
                if (a0Var == null) {
                    synchronized (C9061k.class) {
                        try {
                            a0Var = PARSER;
                            if (a0Var == null) {
