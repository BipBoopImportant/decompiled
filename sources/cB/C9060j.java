...
public final class C9060j extends C9541y<C9060j, b> implements T {
    /* access modifiers changed from: private */
    public static final C9060j DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 2;
    public static final int PARAMS_FIELD_NUMBER = 1;
    private static volatile a0<C9060j> PARSER;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58948a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58948a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58948a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58948a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58948a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58948a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.C9060j.a.<clinit>():void");
        }
    }

    /* renamed from: Cb.j$b */
    public static final class b extends C9541y.a<C9060j, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(int i10) {
            l();
            ((C9060j) this.f68136b).X(i10);
            return this;
        }

        public b y(C9061k kVar) {
            l();
            ((C9060j) this.f68136b).Y(kVar);
            return this;
        }
        ...
        private b() {
            super(C9060j.DEFAULT_INSTANCE);
        }
    }

    static {
        C9060j jVar = new C9060j();
        DEFAULT_INSTANCE = jVar;
        C9541y.N(C9060j.class, jVar);
    }
    ...
    public static C9060j W(C9525h hVar, C9533p pVar) {
        return (C9060j) C9541y.H(DEFAULT_INSTANCE, hVar, pVar);
    }
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58948a[fVar.ordinal()]) {
            ...
            case 5:
                a0<C9060j> a0Var = PARSER;
                if (a0Var == null) {
                    synchronized (C9060j.class) {
                        try {
                            a0Var = PARSER;
                            if (a0Var == null) {
