...
public final class C9056f extends C9541y<C9056f, b> implements T {
    /* access modifiers changed from: private */
    public static final C9056f DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    public static final int PARAMS_FIELD_NUMBER = 2;
    private static volatile a0<C9056f> PARSER = null;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58944a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58944a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58944a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58944a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58944a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58944a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.C9056f.a.<clinit>():void");
        }
    }

    /* renamed from: Cb.f$b */
    public static final class b extends C9541y.a<C9056f, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(C9525h hVar) {
            l();
            ((C9056f) this.f68136b).a0(hVar);
            return this;
        }

        public b y(C9058h hVar) {
            l();
            ((C9056f) this.f68136b).b0(hVar);
            return this;
        }

        public b z(int i10) {
            l();
            ((C9056f) this.f68136b).c0(i10);
            return this;
        }
        ...
        private b() {
            super(C9056f.DEFAULT_INSTANCE);
        }
    }

    static {
        C9056f fVar = new C9056f();
        DEFAULT_INSTANCE = fVar;
        C9541y.N(C9056f.class, fVar);
    }

    private C9056f() {
    }

    public static C9056f U() {
    ...
    public static C9056f Z(C9525h hVar, C9533p pVar) {
        return (C9056f) C9541y.H(DEFAULT_INSTANCE, hVar, pVar);
    }
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58944a[fVar.ordinal()]) {
            ...
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                a0<C9056f> a0Var = PARSER;
                if (a0Var == null) {
                    synchronized (C9056f.class) {
                        try {
                            a0Var = PARSER;
                            if (a0Var == null) {
