...
public final class D extends C9541y<D, b> implements T {
    /* access modifiers changed from: private */
    public static final D DEFAULT_INSTANCE;
    public static final int KEY_INFO_FIELD_NUMBER = 2;
    private static volatile a0<D> PARSER = null;
    public static final int PRIMARY_KEY_ID_FIELD_NUMBER = 1;
    private A.i<c> keyInfo_ = C9541y.t();
    private int primaryKeyId_;

    static /* synthetic */ class a {

        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f58931a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58931a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58931a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58931a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58931a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58931a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58931a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.D.a.<clinit>():void");
        }
    }

    public static final class b extends C9541y.a<D, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(c cVar) {
            l();
            ((D) this.f68136b).T(cVar);
            return this;
        }

        public b y(int i10) {
            l();
            ((D) this.f68136b).X(i10);
            return this;
        }
    ...
    public static final class c extends C9541y<c, a> implements T {
        /* access modifiers changed from: private */
        ...
        public static final class a extends C9541y.a<c, a> implements T {
            /* synthetic */ a(a aVar) {
                this();
            }
            ...
            public a w(int i10) {
                l();
                ((c) this.f68136b).X(i10);
                return this;
            }

            public a y(I i10) {
                l();
                ((c) this.f68136b).Y(i10);
                return this;
            }

            public a z(z zVar) {
                l();
                ((c) this.f68136b).Z(zVar);
                return this;
            }
        ...
        public final Object s(C9541y.f fVar, Object obj, Object obj2) {
            switch (a.f58931a[fVar.ordinal()]) {
                case 1:
                    return new c();
                case 2:
                    return new a((a) null);
                case 3:
                    return C9541y.F(DEFAULT_INSTANCE, "\u0000\u0004\u0000\u0000\u0001\u0004\u0004\u0000\u0000\u0000\u0001Ȉ\u0002\f\u0003\u000b\u0004\f", new Object[]{"typeUrl_", "status_", "keyId_", "outputPrefixType_"});
                case 4:
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58931a[fVar.ordinal()]) {
            ...
            case 2:
                return new b((a) null);
            case 3:
                return C9541y.F(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0001\u0000\u0001\u000b\u0002\u001b", new Object[]{"primaryKeyId_", "keyInfo_", c.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                a0<D> a0Var = PARSER;
