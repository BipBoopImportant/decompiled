...
public final class C9055e extends C9541y<C9055e, b> implements T {
    public static final int AES_CTR_KEY_FORMAT_FIELD_NUMBER = 1;
    /* access modifiers changed from: private */
    public static final C9055e DEFAULT_INSTANCE;
    public static final int HMAC_KEY_FORMAT_FIELD_NUMBER = 2;
    private static volatile a0<C9055e> PARSER;
    private C9057g aesCtrKeyFormat_;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58943a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58943a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58943a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58943a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58943a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58943a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.C9055e.a.<clinit>():void");
        }
    }

    /* renamed from: Cb.e$b */
    public static final class b extends C9541y.a<C9055e, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(C9057g gVar) {
            l();
            ((C9055e) this.f68136b).X(gVar);
            return this;
        }

        public b y(w wVar) {
            l();
            ((C9055e) this.f68136b).Y(wVar);
            return this;
        }
        ...
        private b() {
            super(C9055e.DEFAULT_INSTANCE);
        }
    }

    static {
        C9055e eVar = new C9055e();
        DEFAULT_INSTANCE = eVar;
        C9541y.N(C9055e.class, eVar);
    }
    ...
    public static C9055e W(C9525h hVar, C9533p pVar) {
        return (C9055e) C9541y.H(DEFAULT_INSTANCE, hVar, pVar);
    }

    /* access modifiers changed from: private */
    public void X(C9057g gVar) {
        gVar.getClass();
    ...
    public C9057g T() {
        C9057g gVar = this.aesCtrKeyFormat_;
        return gVar == null ? C9057g.T() : gVar;
    }
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58943a[fVar.ordinal()]) {
            case 1:
                return new C9055e();
            case 2:
                return new b((a) null);
            case 3:
                return C9541y.F(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\t\u0002\t", new Object[]{"aesCtrKeyFormat_", "hmacKeyFormat_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                a0<C9055e> a0Var = PARSER;
                if (a0Var == null) {
                    synchronized (C9055e.class) {
                        try {
                            a0Var = PARSER;
                            if (a0Var == null) {
