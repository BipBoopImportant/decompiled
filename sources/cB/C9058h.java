...
public final class C9058h extends C9541y<C9058h, b> implements T {
    /* access modifiers changed from: private */
    public static final C9058h DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    private static volatile a0<C9058h> PARSER;
    private int ivSize_;
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f58946a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58946a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58946a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58946a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58946a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58946a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58946a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.C9058h.a.<clinit>():void");
        }
    }

    /* renamed from: Cb.h$b */
    public static final class b extends C9541y.a<C9058h, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        private b() {
            super(C9058h.DEFAULT_INSTANCE);
        }
    }

    static {
        C9058h hVar = new C9058h();
        DEFAULT_INSTANCE = hVar;
        C9541y.N(C9058h.class, hVar);
    }

    private C9058h() {
    }

    public static C9058h S() {
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58946a[fVar.ordinal()]) {
            case 1:
                return new C9058h();
            case 2:
                return new b((a) null);
            case 3:
                return C9541y.F(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001\u000b", new Object[]{"ivSize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                a0<C9058h> a0Var = PARSER;
                if (a0Var == null) {
                    synchronized (C9058h.class) {
                        try {
                            a0Var = PARSER;
                            if (a0Var == null) {
