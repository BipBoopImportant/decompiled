...
public final class C9057g extends C9541y<C9057g, b> implements T {
    /* access modifiers changed from: private */
    public static final C9057g DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 2;
    public static final int PARAMS_FIELD_NUMBER = 1;
    private static volatile a0<C9057g> PARSER;
    private int keySize_;
    private C9058h params_;

    /* renamed from: Cb.g$a */
    static /* synthetic */ class a {

        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f58945a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58945a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58945a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58945a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58945a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58945a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58945a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.C9057g.a.<clinit>():void");
        }
    }

    /* renamed from: Cb.g$b */
    public static final class b extends C9541y.a<C9057g, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(int i10) {
            l();
            ((C9057g) this.f68136b).Y(i10);
            return this;
        }

        public b y(C9058h hVar) {
            l();
            ((C9057g) this.f68136b).Z(hVar);
            return this;
        }
        ...
        private b() {
            super(C9057g.DEFAULT_INSTANCE);
        }
    }

    static {
        C9057g gVar = new C9057g();
        DEFAULT_INSTANCE = gVar;
        C9541y.N(C9057g.class, gVar);
    }

    private C9057g() {
    }

    public static C9057g T() {
    ...
    public static C9057g X(C9525h hVar, C9533p pVar) {
        return (C9057g) C9541y.H(DEFAULT_INSTANCE, hVar, pVar);
    }
    ...
    public C9058h V() {
        C9058h hVar = this.params_;
        return hVar == null ? C9058h.S() : hVar;
    }
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58945a[fVar.ordinal()]) {
            case 1:
                return new C9057g();
            case 2:
                return new b((a) null);
            case 3:
                return C9541y.F(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\t\u0002\u000b", new Object[]{"params_", "keySize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                a0<C9057g> a0Var = PARSER;
                if (a0Var == null) {
                    synchronized (C9057g.class) {
                        try {
                            a0Var = PARSER;
                            if (a0Var == null) {
