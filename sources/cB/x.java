...
public final class x extends C9541y<x, b> implements T {
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f58961a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58961a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58961a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58961a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58961a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58961a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58961a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.x.a.<clinit>():void");
        }
    }

    public static final class b extends C9541y.a<x, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(u uVar) {
            l();
            ((x) this.f68136b).X(uVar);
            return this;
        }

        public b y(int i10) {
            l();
            ((x) this.f68136b).Y(i10);
            return this;
        }
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58961a[fVar.ordinal()]) {
            case 1:
                return new x();
            case 2:
                return new b((a) null);
            case 3:
                return C9541y.F(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\f\u0002\u000b", new Object[]{"hash_", "tagSize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                a0<x> a0Var = PARSER;
