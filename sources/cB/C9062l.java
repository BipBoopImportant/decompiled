...
public final class C9062l extends C9541y<C9062l, b> implements T {
    /* access modifiers changed from: private */
    public static final C9062l DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    private static volatile a0<C9062l> PARSER = null;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58950a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58950a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58950a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58950a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58950a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58950a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.C9062l.a.<clinit>():void");
        }
    }

    /* renamed from: Cb.l$b */
    public static final class b extends C9541y.a<C9062l, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(C9525h hVar) {
            l();
            ((C9062l) this.f68136b).X(hVar);
            return this;
        }

        public b y(int i10) {
            l();
            ((C9062l) this.f68136b).Y(i10);
            return this;
        }
        ...
        private b() {
            super(C9062l.DEFAULT_INSTANCE);
        }
    }

    static {
        C9062l lVar = new C9062l();
        DEFAULT_INSTANCE = lVar;
        C9541y.N(C9062l.class, lVar);
    }
    ...
    public static C9062l W(C9525h hVar, C9533p pVar) {
        return (C9062l) C9541y.H(DEFAULT_INSTANCE, hVar, pVar);
    }

    /* access modifiers changed from: private */
    public void X(C9525h hVar) {
        hVar.getClass();
        this.keyValue_ = hVar;
    }
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58950a[fVar.ordinal()]) {
            ...
            case 5:
                a0<C9062l> a0Var = PARSER;
                if (a0Var == null) {
                    synchronized (C9062l.class) {
                        try {
                            a0Var = PARSER;
                            if (a0Var == null) {
