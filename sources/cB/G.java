...
public final class G extends C9541y<G, b> implements T {
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f58934a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58934a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58934a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58934a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58934a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58934a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58934a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.G.a.<clinit>():void");
        }
    }

    public static final class b extends C9541y.a<G, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(H h10) {
            l();
            ((G) this.f68136b).X(h10);
            return this;
        }

        public b y(int i10) {
            l();
            ((G) this.f68136b).Y(i10);
            return this;
        }
    ...
    public static G W(C9525h hVar, C9533p pVar) {
        return (G) C9541y.H(DEFAULT_INSTANCE, hVar, pVar);
    }
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58934a[fVar.ordinal()]) {
            case 1:
                return new G();
            case 2:
                return new b((a) null);
            case 3:
                return C9541y.F(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u000b\u0002\t", new Object[]{"version_", "params_"});
            case 4:
