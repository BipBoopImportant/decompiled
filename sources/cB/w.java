...
public final class w extends C9541y<w, b> implements T {
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f58960a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58960a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58960a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58960a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f58960a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f58960a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f58960a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Cb.w.a.<clinit>():void");
        }
    }

    public static final class b extends C9541y.a<w, b> implements T {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b w(int i10) {
            l();
            ((w) this.f68136b).Y(i10);
            return this;
        }

        public b y(x xVar) {
            l();
            ((w) this.f68136b).Z(xVar);
            return this;
        }
    ...
    public static w X(C9525h hVar, C9533p pVar) {
        return (w) C9541y.H(DEFAULT_INSTANCE, hVar, pVar);
    }
    ...
    public final Object s(C9541y.f fVar, Object obj, Object obj2) {
        switch (a.f58960a[fVar.ordinal()]) {
            case 1:
                return new w();
            case 2:
                return new b((a) null);
            case 3:
                return C9541y.F(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\t\u0002\u000b\u0003\u000b", new Object[]{"params_", "keySize_", "version_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                a0<w> a0Var = PARSER;
