...
public class j extends b {
    ...
    private double[] f25098a;

    /* renamed from: b  reason: collision with root package name */
    private double[][] f25099b;

    /* renamed from: c  reason: collision with root package name */
    private double[][] f25100c;
    ...
    public j(double[] dArr, double[][] dArr2) {
        ...
        this.f25102e = new double[length2];
        int i10 = length - 1;
        int[] iArr = new int[2];
        iArr[1] = length2;
        iArr[0] = i10;
    ...
    private static j i(double[] dArr) {
        double[] dArr2 = dArr;
    ...
    public double c(double d10, int i10) {
        ...
        double k10;
        int i11 = i10;
        double[] dArr = this.f25098a;
        int length = dArr.length;
        int i12 = 0;
        if (this.f25101d) {
            double d13 = dArr[0];
            if (d10 <= d13) {
                d11 = this.f25099b[0][i11];
                d12 = d10 - d13;
                k10 = k(d13, i11);
            } else {
                int i13 = length - 1;
            ...
            return this.f25099b[0][i11];
        } else {
            int i14 = length - 1;
            if (d10 >= dArr[i14]) {
                return this.f25099b[i14][i11];
            }
        }
        while (i12 < length - 1) {
            double[] dArr2 = this.f25098a;
            double d15 = dArr2[i12];
            if (d10 == d15) {
                return this.f25099b[i12][i11];
            }
            int i15 = i12 + 1;
            ...
            if (d10 < d16) {
                ...
                double[][] dArr3 = this.f25099b;
                double d19 = dArr3[i12][i11];
                double d20 = dArr3[i15][i11];
                double[][] dArr4 = this.f25100c;
    ...
    public void d(double d10, double[] dArr) {
        ...
        int i10 = 0;
        int length2 = this.f25099b[0].length;
        if (this.f25101d) {
            double d11 = dArr2[0];
            if (d10 <= d11) {
                f(d11, this.f25102e);
                for (int i11 = 0; i11 < length2; i11++) {
                    dArr[i11] = this.f25099b[0][i11] + ((d10 - this.f25098a[0]) * this.f25102e[i11]);
                }
                return;
            }
            int i12 = length - 1;
            ...
            if (d10 >= d12) {
                f(d12, this.f25102e);
                while (i10 < length2) {
                    dArr[i10] = this.f25099b[i12][i10] + ((d10 - this.f25098a[i12]) * this.f25102e[i10]);
                    i10++;
                }
                return;
            }
        ...
        int i15 = 0;
        while (i15 < length - 1) {
            if (d10 == this.f25098a[i15]) {
                for (int i16 = 0; i16 < length2; i16++) {
                    dArr[i16] = this.f25099b[i15][i16];
                }
            }
            double[] dArr3 = this.f25098a;
            int i17 = i15 + 1;
            ...
            if (d10 < d13) {
                ...
                while (i10 < length2) {
                    double[][] dArr4 = this.f25099b;
                    double d17 = dArr4[i15][i10];
                    double d18 = dArr4[i17][i10];
                    double[][] dArr5 = this.f25100c;
    ...
    public void e(double d10, float[] fArr) {
        ...
        if (this.f25101d) {
            ...
            if (d10 <= d11) {
                f(d11, this.f25102e);
                for (int i11 = 0; i11 < length2; i11++) {
                    fArr[i11] = (float) (this.f25099b[0][i11] + ((d10 - this.f25098a[0]) * this.f25102e[i11]));
                }
                return;
            }
            int i12 = length - 1;
            ...
            if (d10 >= d12) {
                f(d12, this.f25102e);
                while (i10 < length2) {
                    fArr[i10] = (float) (this.f25099b[i12][i10] + ((d10 - this.f25098a[i12]) * this.f25102e[i10]));
                    i10++;
                }
                return;
            }
            ...
            for (int i13 = 0; i13 < length2; i13++) {
                fArr[i13] = (float) this.f25099b[0][i13];
            }
            return;
        } else {
            int i14 = length - 1;
            if (d10 >= dArr[i14]) {
                while (i10 < length2) {
                    fArr[i10] = (float) this.f25099b[i14][i10];
                    i10++;
                }
                return;
            }
        ...
        while (i15 < length - 1) {
            if (d10 == this.f25098a[i15]) {
                for (int i16 = 0; i16 < length2; i16++) {
                    fArr[i16] = (float) this.f25099b[i15][i16];
                }
            }
            double[] dArr2 = this.f25098a;
            int i17 = i15 + 1;
